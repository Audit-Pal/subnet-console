...
import { Shield, Activity, Globe, Lock, Cpu, Server } from "lucide-react";
                                ...
                                >
                                    ...
                                    <div className="space-y-2 font-mono text-[9px]">
                                        ...
                                        <div className="h-10 overflow-hidden relative">
                                            ...
                                            >
                                                <p>VALIDATING_CONSENSUS...</p>
                                                <p>RECURSIVE_CHECK_PASS</p>
                                                <p>NODE_AUTH_OK_150</p>
                                                <p>DISTRIBUTED_ACK_SENT</p>
                                                <p>STREAM_HASH_COMMIT</p>
                                            </motion.div>
                                        </div>
                                    </div>
                                </motion.div>
                                ...
                                >
                                    <div className="relative w-12 h-12">
                                        ...
                                        <motion.div
                                            ...
                                            className="absolute top-2 right-2 w-2 h-2 bg-kast-teal rounded-full shadow-[0_0_10px_#1EBA98]"
                                        />
                                    </div>
                                </motion.div>
                            </div>
